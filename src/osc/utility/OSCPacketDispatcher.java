...
public class OSCPacketDispatcher {
	...
	public void dispatchPacket(OSCPacket packet) throws AWTException, IOException {
		dispatchPacket(packet, null);
	}

	public void dispatchPacket(OSCPacket packet, Date timestamp) throws AWTException, IOException {
	...
	private void dispatchBundle(OSCBundle bundle) throws AWTException, IOException {
	...
	private void dispatchMessage(OSCMessage message, Date time) throws AWTException, IOException {
