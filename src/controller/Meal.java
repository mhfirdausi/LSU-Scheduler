...
public class Meal implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        imgView.fitHeightProperty().bind(Main.primaryStage.heightProperty());
        imgView.fitWidthProperty().bind(Main.primaryStage.widthProperty());
